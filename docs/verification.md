...
# keda-hpa-kafka-consumer-scaler       Deployment/kafka-consumer   ...   0         3         1
...
kubectl describe hpa keda-hpa-kafka-consumer-scaler | grep -A 10 "Metrics:"
```
...
kubectl describe hpa keda-hpa-kafka-consumer-scaler | grep -A 3 "ScaledToZero"
# Conditions:
#   Type            Status  Reason
